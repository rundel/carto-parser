...
struct dot_printer {
    ...
    dot_printer (Out& out_, annotations_type const& annotations_)
      : out(out_), 
...
{
    dot_printer<std::basic_ostream<Char> > printer(out, in.annotations());
                   ...
                   std::basic_string<Char>& out)
{
    ...
    dot_printer<std::basic_stringstream<Char> > printer(oss, in.annotations());
    printer.print(in.ast());
